var questionsArray = [
    ...
    ,
    {
        ...
        answers: [
            ...
            {result: 'I support either a flat tax rate, or cutting taxes for everyone, rich or poor or in the middle. Taxes punish those who produce, and reward those who don`t produce. A smaller government does not need that much revenue from taxes to sustain itself, and ultimately the less taxes, especially for job creators, encourages them to expand which then leads to more jobs for people anyway.',
            party: 'Republican'},
